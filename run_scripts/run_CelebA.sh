...
if [ ! -f  $LOG_NAME ]; then
	OMP_NUM_THREADS=1 python3 train.py --lr_D .0002 --lr_G .0002 --Diters 1 --arch 0 --beta1 .50 --beta2 .999 \
	--gen_every 10000 --print_every 1000 --G_h_size 32 --D_h_size 32 --gen_extra_images 5000 \
	--input_folder '/home/danny/work/ICCV_2019/Datasets/CelebA_HD_Full/gen_by_DS_256' \
	--image_size 256 \
	--total_iters 520000 \
	--seed $SEED \
	--num_workers 8 \
